...
export default function CinematicThemeSwitcher({ motionEnabled = true }: { motionEnabled?: boolean }) {
  ...
  const handleToggle = () => {
    if (motionEnabled) generateParticles();
  ...
  return (
    <div className="relative inline-block">
      ...
      <motion.button
        ...
        className="relative flex h-[64px] w-[104px] items-center rounded-full p-[6px] transition-all duration-300 focus-visible:outline-3 focus-visible:outline-offset-4 focus-visible:outline-amber-400"
        style={{
          background: isDark
      ...
      >
        ...
        >
          ...
          {motionEnabled && isAnimating && particles.map((particle) => (
            <motion.div
              key={particle.id}
